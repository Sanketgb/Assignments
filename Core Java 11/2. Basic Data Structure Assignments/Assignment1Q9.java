...
public class Assignment1Q9{
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            System.out.println("Total marks of all the students in all subjects: " + Student.studentsTotalMarksInAllSubjects(marks));
            System.out.println("Average marks of all the students in all subjects: " + Student.studentsAverageMarksInAllSubjects(marks));
            System.out.println("Total marks scored by students in subject A: " + Student.subjectATotalByStudents(marks));
            System.out.println("Average marks scored by students in subject A: " + Student.subjectAAverageByStudents(marks));
            System.out.println("Total marks scored by students in subject B: " + Student.subjectBTotalByStudents(marks));
            System.out.println("Average marks scored by students in subject B: " + Student.subjectBAverageByStudents(marks));
            System.out.println("Total marks scored by students in subject C: " + Student.subjectCTotalByStudents(marks));
            System.out.println("Average marks scored by students in subject C: " + Student.subjectCAverageByStudents(marks));
        }
