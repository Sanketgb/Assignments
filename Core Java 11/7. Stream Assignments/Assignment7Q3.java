...
public class Assignment7Q3 {
    ...
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            Trader trader1 = new Trader("Sanket Bolamwar","Pune");
            Trader trader2 = new Trader("Mrunal Sharma","Bangalore");
            Trader trader3 = new Trader("Prajwali Sukhadeve","Pune");
            Trader trader4 = new Trader("Jayant Rakhade","Pune");
            Trader trader5 = new Trader("Atul Singh","Indore");
            Trader trader6 = new Trader("Yogesh Rathod","Indore");
